...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Factory unlocked 256GB Apple iPhone 15 Pro Max in pristine Natural Titanium. Aerospace-grade titanium design with Ceramic Shield front and textured matte glass back. Powered by the A17 Pro chip with 6-core GPU. Pro camera system (48MP Main, Ultra Wide, and 5x Telephoto). Battery health 100% with only 14 charge cycles.',
    price: 1099.00,
    originalPrice: 1199.00,
    categoryId: 'cat-electronics',
    subcategory: 'Smartphones & Wearables',
    condition: 'like_new',
    location: 'Austin, TX',
    stock: 5,
    soldCount: 17,
    ...
    shippingOptions: [
      { id: 'ship-ip-1', name: 'Free Insured FedEx 2-Day Air', price: 0, estimatedDays: '2 business days', isFree: true },
      { id: 'ship-ip-2', name: 'Next-Day Express', price: 19.00, estimatedDays: '1 business day' }
    ],
    tags: ['iPhone', 'Apple', 'iPhone 15 Pro Max', 'Titanium', 'Smartphone'],
    status: 'active',
    ...
    specifications: [
      ...
      { name: 'Processor', value: 'A17 Pro (6-core CPU, 6-core GPU)' },
      { name: 'Camera', value: '48MP Main + 12MP Ultra-Wide + 12MP 5x Telephoto' },
      { name: 'Storage', value: '256GB NVMe' },
      { name: 'Charging', value: 'USB-C (USB 3 up to 10Gbps), MagSafe 15W' }
    ]
  },
  {
    id: 'prod-14',
    ...
    sellerRating: 4.95,
    sellerVerified: true,
    title: 'Sony PlayStation 5 Pro Console (2TB High-Speed SSD / 4K 120Hz HDR)',
    description: 'Brand new sealed Sony PlayStation 5 Pro console with 2TB custom NVMe SSD, advanced ray tracing architecture, PlayStation Spectral Super Resolution (PSSR) AI upscaling, and DualSense wireless controller with adaptive triggers and haptic feedback.',
    price: 699.99,
    ...
    shippingOptions: [
      { id: 'ship-ps5-1', name: 'Free Standard Courier', price: 0, estimatedDays: '3-4 business days', isFree: true },
      { id: 'ship-ps5-2', name: 'FedEx Priority Overnight', price: 24.00, estimatedDays: '1 business day' }
    ],
    tags: ['PlayStation 5 Pro', 'Sony', 'Gaming Console', '4K 120Hz', 'PSSR'],
    status: 'active',
    ...
    reviewCount: 42,
    specifications: [
      { name: 'Storage', value: '2TB Custom High-Speed NVMe SSD' },
      { name: 'Graphics', value: 'Advanced RDNA 3 GPU with 67% more Compute Units' },
      { name: 'Performance', value: 'Up to 4K @ 120Hz, 8K output support' },
  ...
  },
  {
    ...
    sellerRating: 4.92,
    sellerVerified: true,
    title: 'Dyson Airwrap Multi-Styler Complete Long (Nickel & Copper Edition)',
    description: 'Authentic Dyson Airwrap Multi-Styler Complete Long engineered for multiple hair types and longer lengths. Employs the aerodynamic Coanda effect to curl, shape, smooth, and hide flyaways without extreme heat damage. Includes 6 re-engineered styling attachments, storage case, and filter cleaning brush.',
    price: 499.99,
    ...
    shippingOptions: [
      { id: 'ship-dyson-1', name: 'Free Tracked Standard Delivery', price: 0, estimatedDays: '2-4 business days', isFree: true }
    ],
    tags: ['Dyson', 'Airwrap', 'Hair Styling', 'Beauty', 'Coanda Effect'],
    status: 'active',
    ...
    reviewCount: 39,
    specifications: [
      { name: 'Motor', value: 'Dyson Digital Motor V9 (110,000 RPM)' },
      { name: 'Heat Regulation', value: 'Intelligent Heat Control (measures 40x per second)' },
      { name: 'Power', value: '1300 Watts' },
      { name: 'Included Barrels', value: '1.2" & 1.6" Long Airwrap Barrels, Firm & Soft Smoothing Brushes, Round Volumizing Brush, Coanda Smoothing Dryer' }
    ]
  },
  {
    id: 'prod-16',
    ...
    sellerRating: 4.88,
    sellerVerified: true,
    title: 'Herman Miller Aeron Ergonomic Chair (Size B / Graphite / PostureFit SL)',
    description: 'Ergonomic industry gold-standard Herman Miller Aeron Remastered in Graphite finish, Size B (Medium). Equipped with dual-pad PostureFit SL lumbar support, fully adjustable 3D armrests, forward tilt limiter, and multi-surface quiet rolling casters.',
    price: 1295.00,
    originalPrice: 1745.00,
    categoryId: 'cat-home',
    subcategory: 'Furniture',
    condition: 'like_new',
    location: 'Portland, OR',
    ...
    soldCount: 16,
    images: [
      'https://images.unsplash.com/photo-1580481077197-28d8dae76161?w=900&auto=format&fit=crop&q=80',
      'https://images.unsplash.com/photo-1505797149-43b0069ec26b?w=900&auto=format&fit=crop&q=80'
    ],
    shippingOptions: [
      { id: 'ship-aeron-1', name: 'Freight Curbside Delivery', price: 55.00, estimatedDays: '4-7 business days' },
      { id: 'ship-aeron-2', name: 'Free Local Pickup', price: 0, estimatedDays: 'Today', isFree: true }
    ],
    tags: ['Herman Miller', 'Aeron Chair', 'Ergonomic', 'Home Office', 'Furniture'],
    status: 'active',
    ...
    reviewCount: 19,
    specifications: [
      { name: 'Size', value: 'Medium (Size B)' },
      { name: 'Suspension', value: '8Z Pellicle Elastomeric Breathable Mesh' },
      { name: 'Lumbar', value: 'Adjustable PostureFit SL Dual Pads' },
      { name: 'Warranty', value: 'Original 12-Year Herman Miller Transferable' }
    ]
  },
  {
    id: 'prod-17',
    ...
    sellerRating: 4.92,
    sellerVerified: true,
    title: 'Nike Air Jordan 1 Retro High OG "Chicago Lost & Found" (Size US 10.5)',
    description: 'Deadstock authenticated Nike Air Jordan 1 Retro High OG in iconic Varsity Red / Black / Sail "Lost & Found" colorway. Featuring cracked leather collar, vintage off-white sail midsole, retro sales receipt graphic tissue paper, and classic mismatch replacement box.',
    price: 385.00,
    ...
    shippingOptions: [
      { id: 'ship-jordan-1', name: 'Free Authenticated & Double-Boxed Shipping', price: 0, estimatedDays: '2-4 business days', isFree: true }
    ],
    tags: ['Jordan 1', 'Chicago Lost and Found', 'Nike', 'Sneakers', 'Streetwear'],
    status: 'active',
    ...
    reviewCount: 27,
    specifications: [
      { name: 'Size', value: 'Men\'s US 10.5 (EU 44.5)' },
      { name: 'Colorway', value: 'Varsity Red / Black / Sail / Muslin' },
      { name: 'Upper Material', value: 'Premium Cracked Finish Full-Grain Leather' },
      { name: 'Condition', value: 'Deadstock with Original Box & Vintage Receipt' }
    ]
  },
  {
    id: 'prod-18',
    ...
    sellerRating: 4.95,
    sellerVerified: true,
    title: 'DJI Mini 4 Pro Drone (Fly More Combo Plus with DJI RC 2 Smart Controller)',
    description: 'Sub-249g ultra-lightweight DJI Mini 4 Pro with omnidirectional obstacle sensing, 4K/60fps HDR true vertical video shooting, and ActiveTrack 360°. Includes DJI RC 2 controller with built-in FHD 700-nit screen, 3 Intelligent Flight Batteries Plus (up to 45 min flight time each), two-way charging hub, and shoulder bag.',
    price: 959.00,
    ...
    shippingOptions: [
      { id: 'ship-dji-1', name: 'Free Insured Express', price: 0, estimatedDays: '2 business days', isFree: true }
    ],
    tags: ['DJI', 'Mini 4 Pro', 'Drone', '4K Video', 'Aerial Photography'],
    status: 'active',
    ...
    reviewCount: 23,
    specifications: [
      { name: 'Takeoff Weight', value: '< 249 grams (Ultralight)' },
      { name: 'Camera', value: '1/1.3-inch CMOS 48MP (f/1.7 aperture)' },
      { name: 'Video Resolution', value: '4K/60fps HDR & 4K/100fps Slow Motion' },
      { name: 'Obstacle Sensing', value: 'Omnidirectional active binocular vision system' },
      { name: 'Transmission', value: 'DJI O4 FHD Video Transmission up to 20 km' }
    ]
  }
];
